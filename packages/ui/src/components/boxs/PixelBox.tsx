...
export default function PixelBox({ children }: PixelBoxProps) {
  return (
    <div className="flex h-full flex-col items-center">
      ...
      <div className="h-full w-full border-x-4 border-x-[#902F00]">
        <div className="h-full w-full border-x-8 border-x-[#FF8C00]">
          <div className="h-full w-full border-x-4 border-x-[#BF4600] bg-[#FFBA7C]">
